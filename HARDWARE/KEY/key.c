...
void key_init(void)
{
	...
	GPIOStructure.GPIO_Pin =GPIO_Pin_1 + GPIO_Pin_2 + GPIO_Pin_3;
...
{
	u32 GPIO_A,GPIO_B,GPIO_Data;
		GPIO_A=((GPIOA->IDR)|(~(KEY2BIT+KEY3BIT +KEY4BIT)));
		GPIO_B=((GPIOB->IDR)|(~(KEY1BIT+KEY2BIT)));
		GPIO_Data=GPIO_B&((GPIO_A<<1)|0x01);
		return GPIO_Data;
}
u32 KeyRead(void)
{
	...
	if(Trg_state)
	{
		if((KEY_Sys_Timer > key_Trgtime)&&(KEY_Sys_Timer<(((u32)0-T_10mS))))  //??
		{
			switch(KEY_Cont)
			{
				case K_1:{Keycode = K_3_S; break;}
				case K_2:{Keycode = K_2_S; break;} 	
				case K_3:{Keycode = K_5_S; break;}
				case K_4:{Keycode = K_1_S; break;}
				case K_5:{Keycode = K_4_S; break;}
	...
	{ 
		...
		switch(KEY_Cont)
		{
			case K_1:{Keycode = K_3_L; break;}
			case K_2:{Keycode = K_2_L; break;}
			case K_3:{Keycode = K_5_L; break;}
			case K_4:{Keycode = K_1_L; break;}
			case K_5:{Keycode = K_4_L; break;}
			default:{Keycode = K_NO; break;} 
		}
	}
	return Keycode;
